...
- **PRCPTOT**: Mean = 1153.94 mm, SD = 213.45 mm
- **SDII**: Mean = 12.51 mm/day, SD = 1.46 mm/day
- **Rx1day**: Mean = 82.61 mm, SD = 27.66 mm
- **Rx5day**: Mean = 141.34 mm, SD = 41.40 mm
- **CDD**: Mean = 80.90 days, SD = 30.64 days
- **CWD**: Mean = 8.71 days, SD = 2.79 days
- **R10mm**: Mean = 36.59 days, SD = 6.88 days
- **R20mm**: Mean = 17.90 days, SD = 4.46 days
- **R50mm**: Mean = 2.76 days, SD = 1.66 days
- **R95p**: Mean = 274.91 mm, SD = 125.61 mm
- **R99p**: Mean = 79.54 mm, SD = 92.37 mm
...
- **PRCPTOT**: Tau = -0.0847, Sen Slope = -15.3111 units/dec, 95% CI = [-49.656, +17.644], P_raw = 0.346353, P_FDR = 0.706706, Status = Non-significant (Decreasing)
- **SDII**: Tau = -0.0935, Sen Slope = -0.1037 units/dec, 95% CI = [-0.338, +0.133], P_raw = 0.298412, P_FDR = 0.706706, Status = Non-significant (Decreasing)
- **Rx1day**: Tau = 0.0643, Sen Slope = +1.6316 units/dec, 95% CI = [-2.667, +5.630], P_raw = 0.475958, P_FDR = 0.706706, Status = Non-significant (Increasing)
- **Rx5day**: Tau = -0.0105, Sen Slope = -0.4348 units/dec, 95% CI = [-6.063, +5.676], P_raw = 0.911479, P_FDR = 0.911479, Status = Non-significant (Decreasing)
- **CDD**: Tau = 0.0503, Sen Slope = +1.2121 units/dec, 95% CI = [-3.000, +4.800], P_raw = 0.578214, P_FDR = 0.706706, Status = Non-significant (Increasing)
- **CWD**: Tau = -0.0526, Sen Slope = +0.0000 units/dec, 95% CI = [-0.556, +0.227], P_raw = 0.556118, P_FDR = 0.706706, Status = Non-significant (No detectable trend)
- **R10mm**: Tau = -0.0240, Sen Slope = +0.0000 units/dec, 95% CI = [-1.250, +0.952], P_raw = 0.793285, P_FDR = 0.872614, Status = Non-significant (No detectable trend)
- **R20mm**: Tau = -0.0959, Sen Slope = -0.3704 units/dec, 95% CI = [-1.053, +0.270], P_raw = 0.284601, P_FDR = 0.706706, Status = Non-significant (Decreasing)
- **R50mm**: Tau = -0.0579, Sen Slope = +0.0000 units/dec, 95% CI = [-0.294, +0.000], P_raw = 0.451230, P_FDR = 0.706706, Status = Non-significant (No detectable trend)
- **R95p**: Tau = -0.0678, Sen Slope = -7.7857 units/dec, 95% CI = [-25.500, +13.837], P_raw = 0.452017, P_FDR = 0.706706, Status = Non-significant (Decreasing)
- **R99p**: Tau = 0.0222, Sen Slope = +0.0000 units/dec, 95% CI = [+0.000, +0.000], P_raw = 0.532865, P_FDR = 0.706706, Status = Non-significant (No detectable trend)
