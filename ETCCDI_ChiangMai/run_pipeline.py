"""
run_pipeline.py — Master reusable pipeline CLI entry point for ETCCDI analysis.

Usage:
    python run_pipeline.py --config config.yaml
    python run_pipeline.py --config path/to/another_station_config.yaml
"""
...
# Parse CLI arguments
parser = argparse.ArgumentParser(description="Run reusable ETCCDI Analysis Pipeline")
parser.add_argument("--config", type=str, default="config.yaml", help="Path to project config.yaml file")
...
# Initialize config module with specified config path
