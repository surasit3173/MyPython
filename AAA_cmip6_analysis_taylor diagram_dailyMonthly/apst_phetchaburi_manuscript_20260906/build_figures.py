"""Build APST-ready Phetchaburi figures from the validated result tables.
...
BOUNDARY = PROJECT / "phetchaburi_data" / "CSV_Phetchaburi - Prachuap Khiri Khan" / "39_amarea_phetchaburi.shp"
ATTACHED_FIG1 = Path(r"D:\CMIP6Phetchaburi\Phetchaburi.png")
FIGDIR = HERE / "figures"
...
def copy_attached_fig1() -> None:
    """Use the user-supplied Phetchaburi map unchanged as Figure 1."""
    if not ATTACHED_FIG1.is_file():
        raise FileNotFoundError(ATTACHED_FIG1)
    shutil.copy2(ATTACHED_FIG1, FIGDIR / "Figure1_Phetchaburi.png")
...
def station_change(result_dir: Path, scenario: str, relative: bool) -> pd.Series:
    c = pd.read_csv(result_dir / "future_change.csv", dtype={"Station": str})
...
def main() -> None:
    ...
    for stale in ["Figure1_station_network.png", "Figure1_station_network.tif", "Figure4_prcptot_idw_coordinate_sensitivity.png", "Figure4_prcptot_idw_coordinate_sensitivity.tif"]:
