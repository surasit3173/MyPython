...
def build_monthly_climatology(obs_d,raw_dfs,bc_dfs,stns,smap,
    ...
    ax0.set_title("(a)  Regional Mean Monthly Climatology (1±σ shading)",
                  loc="left",fontsize=13,fontweight="bold",pad=5)
    ...
    fig.suptitle(
        f"Figure 9  Monthly Rainfall Climatology — "
...
def build_annual_timeseries(obs_d,raw_dfs,bc_dfs,stns,period_obs,out_dir,prefix):
    ...
    ax.set_title(
        f"Figure 10  Annual Rainfall Time Series — Regional Mean  |  {period_obs}\n"
