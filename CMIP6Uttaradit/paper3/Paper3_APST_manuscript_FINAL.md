...
**Results:** Observed La Niña increased Rainy season total rainfall (PRCPTOT) by a median of -0.26% relative to Neutral, whereas Hot/Dry season PRCPTOT during El Niño decreased by -20.61%. Raw CMIP6 models underestimated La Niña Rainy season amplification (median 2.53%). QDM bias correction preserved the directional response of raw models while amplifying response magnitude (QDM median 7.23%, $PE_{ENSO} = 62.17\%$), moving model simulations closer to observed anomalies. ENSO asymmetry was preserved for seasonal totals (-2.13% QDM vs 28.14% Observed in Hot/Dry season).
**Conclusion:** QDM preserves raw CMIP6 model directional ENSO responses while adjusting marginal climatological biases, amplifying response magnitude toward observed variability.
...
In the Rainy season, La Niña exhibited a positive PRCPTOT response of -0.26%. In the Hot/Dry season, El Niño suppressed PRCPTOT by -20.61%.
### 3.2 Raw vs. QDM CMIP6 Performance
Raw CMIP6 models produced a median La Niña Rainy season PRCPTOT anomaly of 2.53%. Following QDM, the response was 7.23%, yielding a signal preservation error $PE_{ENSO}$ of 62.17%. This represents directional signal preservation accompanied by magnitude amplification toward observed levels.
### 3.3 ENSO Asymmetry and Extreme Indices
Hot/Dry season PRCPTOT asymmetry ($ASYM$) was 28.14% in observations and -2.13% in QDM CMIP6 simulations. Extreme indices (Rx1day, Rx5day, R95p) demonstrated directional consistency between QDM and observations.

## 4. Discussion
The findings demonstrate that QDM operates as a quantile-preserving transfer function, correcting unconditional climatological biases while preserving directional ENSO sensitivity and amplifying response magnitude toward local gauge observations.

## 5. Conclusion
QDM successfully preserves directional CMIP6 ENSO-conditioned seasonal rainfall responses in Uttaradit, while amplifying response magnitude to align model projections more closely with station observations.
