...
**Results:** Observed La Niña exhibited a slight median Rainy season total rainfall (PRCPTOT) anomaly of -0.26% relative to Neutral, whereas Hot/Dry season PRCPTOT during El Niño decreased by -17.19%. Raw CMIP6 models underestimated La Niña Rainy season amplification (median 2.53%). QDM bias correction preserved the directional response of raw models while amplifying response magnitude (QDM median 7.23%, $PE_{ENSO} = 62.17\%$), moving model simulations closer to observed anomalies. ENSO asymmetry was preserved for seasonal totals (-12.09% QDM vs 33.10% Observed in Hot/Dry season).
...
In the Rainy season, La Niña exhibited a positive PRCPTOT response of -0.26%. In the Hot/Dry season, El Niño suppressed PRCPTOT by -17.19%.
...
Hot/Dry season PRCPTOT asymmetry ($ASYM$) was 33.10% in observations and -12.09% in QDM CMIP6 simulations. Extreme indices (Rx1day, Rx5day, R95p) demonstrated directional consistency between QDM and observations.
