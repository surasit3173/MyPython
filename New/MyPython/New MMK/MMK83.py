...
"""
===============================================================================
Q2-Q3 Standard Rainfall Trend Analysis (Publication Ready)
- Table 2, Table 3, Table 5 ตามตัวอย่าง
- กราฟ MK vs MMK + กราฟเปรียบเทียบความแตกต่างของนัยสำคัญ
    ...
    for f in files:
        ...
        for st in stations:
            ...
            for s_name, series in seasons.items():
                ...
                # Table 3: Modified MK
                table3.append([st, s_name, round(r1, 4), round(Z_mmk, 4), 
