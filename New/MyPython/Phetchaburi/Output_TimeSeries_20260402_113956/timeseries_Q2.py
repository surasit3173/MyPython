...
def fig3a_seasonal_all_models(obs_d, raw_models, bc_models,
    ...
    fig.suptitle(
        f"(a)  Seasonal Cycle: All CMIP6 Models + Ensemble Mean — Spatial Mean ({len(stns)} Stations)",
...
def fig3b_seasonal_ensemble(obs_d, ens_raw_d, ens_bc_d,
    ...
    fig.suptitle(
        f"(b)  Seasonal Cycle: Ensemble Mean — Observed vs CMIP6 Raw vs Bias-Corrected  |  {len(stns)} Stations",
        fontsize=FS["fig_title"], fontweight="bold")
...
def main():
    ...
    _single_heatmap(raw_bias,
                    ...
                    f"(a)  Monthly Relative Bias: Ensemble Mean (CMIP6 Raw)  |  {period_obs}",
    ...
    _single_heatmap(bc_bias,
                    ...
                    f"(b)  Monthly Relative Bias: Ensemble Mean (Bias-Corrected)  |  {period_obs}",
    ...
    _single_heatmap(reduction,
                    ...
                    f"(c)  Monthly Bias Reduction: Raw → Bias-Corrected  |  {period_obs}",
