...
fig_report = f"""# FINAL FIGURE VISUAL QA REPORT — APST MARKOV RAINFALL ANALYSIS
...
with open('FINAL_FIGURE_VISUAL_QA_REPORT.md', 'w') as f:
    f.write(fig_report)

print("FINAL_FIGURE_VISUAL_QA_REPORT.md GENERATED.")
