#!/usr/bin/env python3
"""Prepare the supplementary material: display tables and data files.

    python docx_build_p2/prepare_supplement.py --config config/uttaradit.yaml
...
def main() -> None:
    ...
    payload = {"title": "Climate-Signal Preservation of Bias-Corrected Daily "
                        "Precipitation from Global Climate Models: A Comparison "
                        "of Quantile Mapping Methods over Uttaradit, Thailand",
               ...
               "out": str(src / "Paper2_Supplementary_FINAL.docx")}
