...
const AFTER_SH = {
  "2.1 Study area and data": () => [
    figure("Paper2_Figure_01_study_area.png", 3.6),
    cap("Figure 1"),
  ],
  ...
  "3.6 Relative roles of GCM and method effects": () => [
    ...
    figure("Paper2_Figure_06_synthesis.png", 5.0),
    cap("Figure 5"),
  ],
};
