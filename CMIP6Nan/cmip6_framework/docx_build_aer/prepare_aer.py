#!/usr/bin/env python3
"""Prepare the Paper 2 Word build inputs for Applied Environmental Research.

    python docx_build_aer/prepare_aer.py --config config/uttaradit.yaml
...
def main() -> None:
    ...
    (HERE / "paths.json").write_text(json.dumps({
        ...
        "out": str(src / "Paper2_AER_manuscript.docx"),
